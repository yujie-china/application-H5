  ...
  <div class="application_info">
    <van-form class="warp" :model="FormData" label-align="top">
      <van-cell-group inset>
        <van-field v-model="FormData.position" :rules="apjobRules" maxlength="11" label="申请职位" placeholder="申请职位" required />
        <van-field v-model="FormData.other_position" maxlength="11" label="其他感兴趣的职位" placeholder="其他感兴趣的职位" />
        <van-field v-model="FormData.price" :rules="priRules" maxlength="11" label="期望待遇" placeholder="xxx/月" required />
        ...
        <van-cell-group v-if="FormData.isAgain === '1'">
          <van-field v-model="FormData.position" maxlength="11" label="面试职位" placeholder="面试职位" />
        ...
        <van-radio-group direction="horizontal">
          ...
          <van-field v-if="cascaderValue === '6'" class="input_other" label-align="left" v-model="FormData.road" maxlength="24"
            label="其他途径:" placeholder="请说明" />
        </van-radio-group>
      </van-cell-group>
    </van-form>
  </div>
...
import { ref } from "vue";
import {apjobRules, priRules} from "@/utils/rules.ts";
const FormData = ref({
  position: "",
  other_position: "",
  price: "",
