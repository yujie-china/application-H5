  ...
  <div class="application_info">
    ...
    <van-form label-align="top">
      <van-cell-group inset v-for="(FormData, index) in FormDatas" :key="index">
        <van-field v-model="FormData.school_name" label="学校名称" placeholder="学校名称" />
        ...
        <van-field v-model="FormData.major" label="专业" placeholder="填写专业" />
        <van-field v-model="FormData.study_way" label="学习方式" placeholder="全日制/非全日制" />
        <van-field v-model="FormData.qualifications" label="学历" placeholder="填写学历" />
      </van-cell-group>
      <div class="btns">
