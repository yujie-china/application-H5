    ...
    <van-form label-align="top">
      ...
      <van-cell-group inset v-for="(FormData, index) in FormDatas" :key="index">
        <van-row gutter="24">
          ...
          <van-col :span="13">
            <van-field v-model="FormData.school_name" maxlength="24" :rules="snameRules" label="学校名称" placeholder="学校名称" required />
          </van-col>
          <van-col :span="11">
            <van-field v-model="FormData.major" maxlength="11" :rules="majRules" label="专业" placeholder="填写专业" required />
          </van-col>
          <van-col :span="13">
            <van-field v-model="FormData.study_way" maxlength="4" :rules="stuwayRules" label="学习方式" placeholder="全日制/非全日制" required />
          </van-col>
          <van-col :span="11">
            <van-field v-model="FormData.qualifications" maxlength="3" :rules="quaRules" label="学历" placeholder="填写学历" required />
          </van-col>
